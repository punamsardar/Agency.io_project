      ...
      <div className=" flex justify-between lg:items-center max-lg:flex-col gap-10  ">
        ...
        >
          <img
            ...
            alt=""
            className="w-22 sm:w-44 mb-3"
          />
          <p className="max-w-md mb-3">
            From stratergy to excution , we craft digital solutions that move
        ...
        >
          ...
          <p className="text-sm mt-2 mb-6">
            The latest news , article and ,resources , sent to your your inbox
            weekly .
          </p>
