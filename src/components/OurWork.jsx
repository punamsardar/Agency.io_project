...
const OurWork = () => {
  const workData = [
    ...
    },
    {
      ...
      description: "We help  you execute your plan deliver results.",
      icon: assets.work_dashboard_management,
    },
    {
      title: "Fitness app promotion",
      description:
        "We help you create a marking stratergy that drives results.",
  ...
  return (
    ...
    >
      <Title
        ...
        desc="From stratergy to excution , we craft digital solutions that move your business forward."
      />
